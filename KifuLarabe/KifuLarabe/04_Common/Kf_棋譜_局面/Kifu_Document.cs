...
namespace Grayscale.KifuwaraneLib.L04_Common
{
    ...
    public class Kifu_Document
    {
        ...
        public Kifu_Document()
        {
            ...
            LoggerImpl.GetInstance().WriteLineMemo(LarabeLoggerTag_Impl.LINKED_LIST, "リンクトリストは作られた"+this.DebugText_Kyokumen7(this, "ルートが追加されたはずだぜ☆"));
        }
        ...
        public IKifuElement PopCurrent1()
        {
            ...
            LoggerImpl.GetInstance().WriteLineMemo(LarabeLoggerTag_Impl.LINKED_LIST, "リンクトリストの最後の要素が削除された");
        ...
        /// 駒袋には、不成にして入れておきます。
        /// </summary>
        public void SetKyokumen_ToKomabukuro3(Kifu_Document kifuD, ILoggerElement logTag)
        {
        ...
        /// ************************************************************************************************************************
        /// </summary>
        public void SetStartpos_KokokaraSaifu(Kifu_Document kifuD, Sengo sengo, ILoggerElement logTag)
        {
            ...
            )
        {
            ...
            LoggerImpl.GetInstance().WriteLineMemo(LarabeLoggerTag_Impl.LINKED_LIST, "ノードが１つ追加されたぜ☆ｗｗ　：　[" + kifuD.CountTeme(kifuD.Current8) + "]手目　：　hint=[" + hint + "]");
            ...
            )
        {
            ...
            KomaHouse newHouse;
            {
                ...
                LoggerImpl.GetInstance().WriteLineMemo(LarabeLoggerTag_Impl.LINKED_LIST, newHouse.Log_Kyokumen(this, this.CountTeme(this.Current8), "増えたニュー局面"));
            }
            ...
            )
        {
            ...
            LoggerImpl.GetInstance().WriteLineMemo(LarabeLoggerTag_Impl.LINKED_LIST, "リンクトリストに、ノードは追加された hint=[" + hint + "] te=[" + newNode.TeProcess.ToSfenText() + "] memberName=[" + memberName + "] sourceFilePath=[" + sourceFilePath + "] sourceLineNumber=[" + sourceLineNumber + "]");
        }
            ...
            )
        {
            ...
            LoggerImpl.GetInstance().WriteLineMemo(logTag, "リンクトリストの、最終ノードは差し替えられた hint=[" + hint + "] item=[" + item.ToSfenText() + "] memberName=[" + memberName + "] sourceFilePath=[" + sourceFilePath + "] sourceLineNumber=[" + sourceLineNumber + "]");
        ...
        public void ClearA()
        {
            ...
            LoggerImpl.GetInstance().WriteLineMemo(LarabeLoggerTag_Impl.LINKED_LIST, "リンクトリストは、クリアーされた");
        }
