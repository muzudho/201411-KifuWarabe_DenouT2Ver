...
namespace Grayscale.KifuwaraneLib
{
    public interface IKomaPos
    {
        ...
        /// </summary>
        /// <returns></returns>
        bool NeverOnaji(Kifu_Document kifuD, ILoggerAddress logTag, params List<K40>[] komaGroupArgs);
        ...
        /// <returns></returns>
        bool ExistsIn(IMasus masu2Arr, Kifu_Document kifuD, ILoggerAddress logTag);
