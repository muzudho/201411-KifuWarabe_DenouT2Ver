...
namespace Grayscale.KifuwaraneEntities.ApplicatedGame.Architecture
{
    ...
    public class TreeDocument
    {
        ...
        public IKifuElement PopCurrent1()
        {
            ...
            Logger.TraceLine(LogTags.LinkedListLog, "リンクトリストの最後の要素が削除された");
            ...
            )
        {
            ...
            Logger.TraceLine(LogTags.LinkedListLog, "ノードが１つ追加されたぜ☆ｗｗ　：　[" + kifuD.CountTeme(kifuD.Current8) + "]手目　：　hint=[" + hint + "]");
            ...
            )
        {
            ...
            Logger.TraceLine(LogTags.LinkedListLog, "リンクトリストに、ノードは追加された hint=[" + hint + "] te=[" + newNode.TeProcess.ToSfenText() + "] memberName=[" + memberName + "] sourceFilePath=[" + sourceFilePath + "] sourceLineNumber=[" + sourceLineNumber + "]");
        }
