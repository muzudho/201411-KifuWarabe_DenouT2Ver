...
namespace Grayscale.KifuwaraneGui.L09_Ui
{
    public abstract class Util_MenuDrawer
    {
        ...
        public static void DrawKomaokuri1(ref RequestForMain requestForMain, Shape_PnlTaikyoku shape_PnlTaikyoku, Kifu_Document kifuD, ILoggerAddress logTag)
        {
            //------------------------------------------------------------
            // 駒・再描画
            //------------------------------------------------------------
        ...
        public static void DrawKomaokuri2(ref RequestForMain requestForMain, Shape_PnlTaikyoku shape_PnlTaikyoku, Kifu_Document kifuD, ILoggerAddress logTag)
        {
            //------------------------------
            // メナス
            //------------------------------
