...
namespace Grayscale.KifuwaraneGui.L09_Ui
{
    ...
    public class FlowB_1TumamitaiKoma : FlowB
    {
        ...
        public static void Check_MouseoverKomaKiki(IKomaPos koma, Shape_PnlTaikyoku shape_PnlTaikyoku, Kifu_Document kifuD, ILoggerElement logTag)
        {
        ...
        /// </summary>
        public static void Menace(ref RequestForMain requestForMain, Shape_PnlTaikyoku shape_PnlTaikyoku, Kifu_Document kifuD, ILoggerElement logTag)
        {
